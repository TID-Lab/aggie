...
import SourceTable, {LoadingSourceTable} from "../../components/source/SourceTable";
...
const SourcesIndex = (props: IProps) => {
  ...
  const credentialsQuery = useQuery<Credential[] | undefined, AxiosError>("credentials", getCredentials);
              ...
              { sourcesQuery.isSuccess && credentialsQuery.isSuccess && sourcesQuery.data && credentialsQuery.data &&
                  <Card className="mt-3">
                    <Card.Header as={ButtonToolbar} className="justify-content-end">
                      <SourceModal variant={"dropdown"} credentials={credentialsQuery.data}></SourceModal>
                    </Card.Header>
