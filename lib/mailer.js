...
var Mailer = function() {
  var method;
  switch (config.email.transport.method) {
  case 'SES':
    method = require('nodemailer-ses-transport');
    break;
  case 'sendgrid':
    method = require('nodemailer-sendgrid-transport');
    break;
  case 'SMTP':
    // Creating transport for SMTP does not require special method, just the options
    method = function(opts) { return opts; };
    break;
  default:
