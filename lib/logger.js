...
// Activity logger for users
logger.logActivity = function(message) {
  // Add a timestamp field, with new Date(); Not even necessary
  // Somehow add this to the collection.
  console.log("This object will be added to the log collection");
  console.log(message);
};
