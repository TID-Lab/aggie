 ...
 */
async function fetchSourceByID(source) {
...
function createChannel(source) {
    ...
    switch(media) {
        ...
        case 'instagram':
            options = {
                ...options,
                dashboardToken: dashboardAPIToken,
                queryParams: {
                    // TODO listIds
                    searchTerm: keywords, // TODO rename
                },
            };
            switch(media) {
                case 'facebook':
...
/**
 * Creates and starts a Channel for each Source.
 */
