...
contentServices.instagram = require('./content-services/instagram-content-service');
...
ContentServiceFactory.prototype.create = function(source) {
  ...
  // Content services use only the lastReportDate, url, keywords, tags, and dashboardAPIToken params.
  var basicSource = _.pick(source, 'lastReportDate', 'lastReportDateSavedSearch','url', 'keywords', 'tags', 'dashboardAPIToken');
