...
var InstagramContentService = function(options) {
	CrowdTangleContentService.call(this, options);
}

util.inherits(InstagramContentService, CrowdTangleContentService);

InstagramContentService.prototype._parse = function(data, options) {
	var metadata = {
...
InstagramContentService.prototype.doesReportMatchWords = function(words, content, metadata) {
	try{
...
module.exports = InstagramContentService;
