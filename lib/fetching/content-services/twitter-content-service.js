...
TwitterContentService.prototype.subscribe = function(id, info) {
  ...
  this._acceptedLanguages[id] = info.acceptedLanguages;
...
// We also check if the bots accept the tweet language. We discard it otherwise.
TwitterContentService.prototype._makeReport = function(tweet) {
  ...
  var matchingBots = _.pickBy(this._connectedSources, function(ignore, botId) {
    ...
    var langs = self._acceptedLanguages[botId];
    var languageMatches = langs == '' || tweet.lang === 'und'
        || _.indexOf(langs, tweet.lang) >= 0;
    var b = languageMatches && tweetMatches(tweet, compiled);
    return b;
  });
...
// Hack for getting only tweets geolocated in Lybia
var libya = [5, 20.25, 25.5, 33.15];
// Gets a Twit stream object
TwitterContentService.prototype._getStream = function() {
  return this._twit.stream(this._streamName, { track: this._keywords, locations: libya });
};
