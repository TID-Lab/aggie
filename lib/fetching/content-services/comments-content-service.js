...
CommentContentService.prototype._sendRequest = function(url, opts, callback) {
    ...
    request(url, opts, (err, res, body) => {
        ...
        console.log('=======================')
        console.log('FOR MAX:');
        console.log(`OLD lastFetch: ${this._lastFetchDate}`)
        console.log(`OLD lastAuthored: ${this._lastAuthoredDate}`)
        console.log(`NEW lastFetch: ${lastFetchDate}`)
        console.log(`NEW lastAuthored: ${lastAuthoredDate}`)
        console.log('=======================')
