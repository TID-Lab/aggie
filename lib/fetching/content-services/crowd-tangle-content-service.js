...
// zawgyiConvertor = new myanmar_tools.ZawgyiConverter();
// zawgyiDetector = new myanmar_tools.ZawgyiDetector();
// var text_arr= ["This is a test to see what zwagyi returns when text is english", "😃", "မ္း"];

// for(var index in text_arr){
// 	console.log("Zwagyi probability of " + text_arr[index] + " : " + zawgyiDetector.getZawgyiProbability(text_arr[index]));
// 	if (zawgyiDetector.getZawgyiProbability(text_arr[index]) >=0.9){ 
// 		var text = zawgyiConvertor.zawgyiToUnicode(text_arr[index]);
// 		console.log("Unicode : " + text)
// 	}else{
// 		console.log("Text is already unicode");
// 	}
// }
