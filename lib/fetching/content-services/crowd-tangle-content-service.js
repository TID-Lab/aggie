		...
		this._httpRequest({url: requestUrl}, function(err, res, body) {
			if (err) {
				...
				if (res.statusCode === 403) {
					// Temporarily ignore "forbidden" errors until we have a better practice for handling them.
					// "This list does not belong to the dashboard associated with your token. Either use a token associated with the proper dashboard or correct your list id."
				} else {
