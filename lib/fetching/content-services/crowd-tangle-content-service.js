...
var CrowdTangleContentService = function(options) {
	this._baseUrl = "https://api.crowdtangle.com/" // config.get().crowdtangle.baseUrl
	this._pathName = "posts/"// config.get().crowdtangle.pathName
	this._count = 50 //config.get().crowdtangle.count
	this._language = "en" // config.get().crowdtangle.language
	this._sortParameter = "overperforming" // config.get().crowdtangle.sortParameter
	this._apiToken = "M0C5MC7DNUZvIARA2OpshYFyPdJtYEg1k4rKJSef"
