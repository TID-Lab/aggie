...
ELMOContentService.prototype.fetch = function(options, callback, url) {
  ...
  this._fetchPage(url, function(res, data) {
    ...
    if (data && nextPage) {
      ...
      if (self._data) {
        self._handleResults(self._data, maxCount);
        delete self._data;
      }
...
ELMOContentService.prototype._handleResults = function(data, maxCount) {
  var self = this;
