...
var ELMOContentService = function(options) {
  this._authToken = options.authToken ||
    (config.get().elmo && config.get({ reload: true }).elmo.authToken);
...
ELMOContentService.prototype._reloadSettings = function() {
  this._authToken = config.get({ reload: true }).elmo.authToken;
};
