...
var settingsController = require('./api/controllers/settings-controller');
app.use(settingsController);

require('./api/controllers/incident-controller')(app, user);
...
var trendController = require('./api/controllers/trend-controller')(app, user);
