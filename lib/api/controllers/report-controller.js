...
module.exports = function(app, user) {
  ...
  app.get('/api/report', user.can('view data'), function(req, res) {
  ...
  // Load batch
  app.get('/api/report/batch', user.can('view data'), function(req, res) {
  ...
  // Checkout new batch
  app.patch('/api/report/batch', user.can('edit data'), function(req, res) {
  ...
  // Cancel batch
  app.put('/api/report/batch', user.can('edit data'), function(req, res) {
  ...
  // Get Report by id
  app.get('/api/report/:_id', function(req, res) {
  ...
  // Update Report data
  app.put('/api/report/:_id', user.can('edit data'), function(req, res) {
    // Find report to update
    Report.findById(req.params._id, function(err, report) {
      if (err) return res.send(err.status, err.message);
      if (!report) return res.send(404);
      // Update the actual value
      _.each(_.pick(req.body, ['_group', 'read', 'smtcTags', 'notes', 'escalated', 'veracity']), function(val, key) {
        report[key] = val;
      });
      // Save report
  ...
  // Delete all reports
  app.delete('/api/report/_all', user.can('edit data'), function(req, res) {
  ...
  app.patch('/api/report/_veracity', user.can('edit data'), function(req, res) {
  ...
  app.patch('/api/report/_read', user.can('edit data'), function(req, res) {
    if (!req.body.ids || !req.body.ids.length) return res.send(200);
    Report.find({ _id: { $in: req.body.ids } }, function(err, reports) {
      if (err) return res.send(err.status, err.message);
      if (reports.length === 0) return res.send(200);
  ...
  app.patch('/api/report/_escalate', user.can('edit data'), function(req, res) {
    if (!req.body.ids || !req.body.ids.length) return res.send(200);
    Report.find({ _id: { $in: req.body.ids } }, function(err, reports) {
      if (err) return res.send(err.status, err.message);
      if (reports.length === 0) return res.send(200);
  ...
  app.patch('/api/report/_link', user.can('edit data'), function(req, res) {
    if (!req.body.ids || !req.body.ids.length) return res.send(200);
    Report.find({ _id: { $in: req.body.ids } }, function(err, reports) {
      if (err) return res.send(err.status, err.message);
      if (reports.length === 0) return res.send(200);
  ...
  app.patch('/api/report/_unlink', user.can('edit data'), function(req, res) {
    if (!req.body.ids || !req.body.ids.length) return res.send(200);
    Report.find({ _id: { $in: req.body.ids } }, function(err, reports) {
      if (err) return res.send(err.status, err.message);
      if (reports.length === 0) return res.send(200);
  ...
  // Update Notes
  app.patch('/api/report/_updateNotes', user.can('edit data'), function(req, res) {
    if (!req.body.ids || !req.body.ids.length) return res.send(200);
    Report.find({ _id: { $in: req.body.ids } }, function(err, reports) {
      if (err) return res.send(err.status, err.message);
      if (reports.length === 0) return res.send(200);
  ...
  // Update Escalated
  app.patch('/api/report/_updateEscalated', user.can('edit data'), function(req, res) {
    if (!req.body.ids || !req.body.ids.length) return res.send(200);
    Report.find({ _id: { $in: req.body.ids } }, function(err, reports) {
      if (err) return res.send(err.status, err.message);
      if (reports.length === 0) return res.send(200);
  ...
  app.patch('/api/report/_updateVeracity', user.can('edit data'), function(req, res) {
    if (!req.body.ids || !req.body.ids.length) return res.send(200);
    Report.find({ _id: { $in: req.body.ids } }, function(err, reports) {
      if (err) return res.send(err.status, err.message);
      if (reports.length === 0) return res.send(200);
  ...
  app.patch('/api/report/_tag', user.can('edit data'), function(req, res) {
    if (!req.body.ids || !req.body.ids.length) return res.send(200);
    Report.find({ _id: { $in: req.body.ids } }, function(err, reports) {
      if (err) return res.send(err.status, err.message);
      if (reports.length === 0) return res.send(200);
  ...
  app.patch('/api/report/_untag', user.can('edit data'), function(req, res) {
    if (!req.body.ids || !req.body.ids.length) return res.send(200);
    Report.find({ _id: { $in: req.body.ids } }, function(err, reports) {
      if (err) return res.send(err.status, err.message);
      if (reports.length === 0) return res.send(200);
  ...
  app.patch('/api/report/_clearTags', user.can('edit data'), function(req, res) {
    if (!req.body.ids || !req.body.ids.length) return res.send(200);
    Report.find({ _id: { $in: req.body.ids } }, function(err, reports) {
      if (err) return res.send(err.status, err.message);
      if (reports.length === 0) return res.send(200);
