...
module.exports = function(app, user) {
  ...
  // Create a new Trend
  app.post('/api/trend', user.can('manage trends'), function(req, res) {
    // Parse query data
  ...
  app.get('/api/trend', user.can('view data'), function(req, res) {
  ...
  // Get a Trend by _id
  app.get('/api/trend/:_id', user.can('view data'), function(req, res) {
    var page = req.query.page || 1;
  ...
  // Toggle a Trend
  app.put('/api/trend/:_id/:op', user.can('manage trends'), function(req, res, next) {
  ...
  // Delete a Trend
  app.delete('/api/trend/:_id', user.can('manage trends'), function(req, res, next) {
  ...
  // Delete all Trends
  app.delete('/api/trend/_all', user.can('manage trends'), function(req, res) {
...
function parseQueryData(data) {
  ...
  return _.pick(data, ['keywords', 'media', 'sourceId', 'groupId']);
}
