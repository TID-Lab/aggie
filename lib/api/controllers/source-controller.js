...
module.exports = function(app, user) {
  ...
  // Create a new Source
  app.post('/api/source', user.can('edit data'), function(req, res) {
  ...
  app.get('/api/source', user.can('view data'), function(req, res) {
  ...
  // Get a Source by _id
  app.get('/api/source/:_id', user.can('view data'), function(req, res) {
  ...
  // Update a Source
  app.put('/api/source/:_id', user.can('edit data'), function(req, res, next) {
  ...
  app.put('/api/source/_events/:_id', user.can('edit data'), function(req, res) {
  ...
  // Delete a Source
  app.delete('/api/source/:_id', user.can('edit data'), function(req, res, next) {
  ...
  // Delete all Sources
  app.delete('/api/source/_all', user.can('delete data'), function(req, res) {
