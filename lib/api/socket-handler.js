...
// TODO figure out how to log all Socket events w/ new Socket.IO API!
...
SocketHandler.prototype._configureSocketIO = function() {
  var self = this;
  var io = this.io;
  // TODO io.configure is gone from Socket.io (as is io.enable, set, etc.)
  // See: https://github.com/socketio/socket.io/issues/1847#issuecomment-61384590
  ...
  // Authorize sockets
  // TODO migrate to latest socket.io here too (io.set for auth is deprecated) see:
