...
// test();
// async function test() {
//     updateCTList().then((message) => console.log(message));
//     // console.log(content);
//     // .then(function(data) {
//     //   console.log(data);
//     // })
...
function writeFile(content) {
    ...
    fs.writeFile(path.resolve(__dirname, '../../config/crowdtangle_list.json'), JSON.stringify(content, null, '\t'), function (err) {
        if (err)
            throw err;
    });
}
