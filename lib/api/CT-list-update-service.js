        ...
        while (lists.length !== 0) {
            ...
            accountResponse.forEach(account => {
                if(!(account.id in content.crowdtangle_list_account_pairs)){
                    ...
                    content.crowdtangle_list_account_pairs[account.id].indexOf(list.metadata.title) === -1 && content.crowdtangle_list_account_pairs[account.id].push(list.metadata.title); //if listname is not in the array, then it will be added. 
                }
