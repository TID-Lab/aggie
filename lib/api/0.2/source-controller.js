...
module.exports = function(app) {
  ...
  // Create a new Source
  app.post('/api/' + API_VERSION + '/source', function(req, res) {
  ...
  app.get('/api/' + API_VERSION + '/source', function(req, res) {
  ...
  // Get a Source by _id
  app.get('/api/' + API_VERSION + '/source/:_id', function(req, res) {
  ...
  // Update a Source
  app.put('/api/' + API_VERSION + '/source/:_id', function(req, res, next) {
  ...
  app.put('/api/' + API_VERSION + '/source/_events/:_id', function(req, res) {
  ...
  // Delete a Source
  app.delete('/api/' + API_VERSION + '/source/:_id', function(req, res, next) {
  ...
  // Delete all Sources
  app.delete('/api/' + API_VERSION + '/source/_all', function(req, res) {
