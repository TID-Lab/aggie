...
module.exports = function(app, user) {
  ...
  app.post('/api/v1/credentials', user.can('change settings'), async function (req, res) {
    try {
  ...
  app.delete('/api/v1/credentials/:_id', user.can('change settings'), async function (req, res) {
  ...
  app.get('/api/v1/credentials', user.can('change settings'), async function (req, res) {
    try {
  ...
  app.get('/api/v1/credentials/:_id', user.can('change settings'), async function (req, res) {
    const { _id } = req.params;
    try {
