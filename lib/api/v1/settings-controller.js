...
app.put('/api/v1/settings/updateCTList', async function(req, res) {
  updateCTList(req, res, new CTListUpdateService());
});

if (process.env.NODE_ENV === 'test') {
  app.put('/api/v1/settings/updateCTList/:directory', async function(req, res) {
    updateCTList(req, res, new CTListUpdateService({directory: req.params.directory}));
  });
}
