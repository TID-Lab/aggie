...
var test = require('../../fetching/content-services/test-content-services.js');
...
app.put('/api/v1/settings/media/:media', user.can('change settings'), function (req, res) {
  config.updateMedia(req.params.media, req.body.settings, function (err) {
    if (err) {
      res.send(500);
    }
...
app.post('/api/v1/settings/media/:media', user.can('change settings'), function (req, res) {
