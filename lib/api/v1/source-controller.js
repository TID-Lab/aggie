...
module.exports = function(app) {
  ...
  // Create a new Source
  app.post('/api/v1/source', function(req, res) {
  ...
  // Get a Source by _id
  app.get('/api/v1/source/:_id', function(req, res) {
  ...
  // Update a Source
  app.put('/api/v1/source/:_id', function(req, res, next) {
  ...
  app.put('/api/v1/source/_events/:_id', function(req, res) {
  ...
  // Delete a Source
  app.delete('/api/v1/source/:_id', function(req, res, next) {
  ...
  // Delete all Sources
  app.delete('/api/v1/source/_all', function(req, res) {
