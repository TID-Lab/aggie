...
.controller('SourcesIndexController', [
  ...
  function($scope, $rootScope, flash, sources, Source, Tags) {
    ...
    $scope.target = function(source) {
      return source.media == 'twitter' || source.media == 'smsgh' || source.media == 'whatsapp' || source.media == 'ushahidi' ? source.keywords : source.url;
    };

    $scope.sourceClass = function(source) {
      var mediaOptions = ['twitter', 'facebook', 'rss', 'elmo', 'smsgh', 'whatsapp', 'ushahidi'];
