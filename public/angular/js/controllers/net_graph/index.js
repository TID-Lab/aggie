        ...
        function ($scope, Socket, reports) {
            ...
            $scope.createNetworkGraph = function () {
                ...
                try {
                    ...
                    $scope.graph.nodes.forEach(function (d, i) {
                    ...
                    var graphLayout = d3.forceSimulation($scope.graph.nodes)
                        .force("charge", d3.forceManyBody().strength(-3000))
                        .force("center", d3.forceCenter(width / 2, height / 2))
                        .force("x", d3.forceX(width / 2).strength(1))
                        .force("y", d3.forceY(height / 2).strength(1))
                        .force("link", d3.forceLink($scope.graph.links).id(function (d) {
                            return d.id;
